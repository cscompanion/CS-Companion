...
public class RemindersAdapterv2 extends RecyclerView.Adapter<RemindersAdapterv2.MyViewHolder> {

    Context context;
    ArrayList<remindersDatabase> remindersDatabase;

    public RemindersAdapterv2(Context c, ArrayList<remindersDatabase> p){
        context = c;
        remindersDatabase = p;
    }
